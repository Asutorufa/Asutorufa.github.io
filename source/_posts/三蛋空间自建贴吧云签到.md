...
![](/images/posts/8a291f21/90cebe21cc5f.png)

写上名字和密码,点击create

![](/images/posts/8a291f21/5220d289271a.png)

### ftp 
下载SmartFTP Client或者其他你熟悉的ftp上传工具,这里百度就行了
进入三蛋空间的管理网站,点击这里,如图

![](/images/posts/8a291f21/4d04f06e2e02.png)
![](/images/posts/8a291f21/4ad83b1ee168.png)

把这里的信息填入SmartFTP Client中

![](/images/posts/8a291f21/93b2773e53f4.png)
然后点ok
...
![](/images/posts/8a291f21/b1532377a19e.png)

将解压得到的所有文件拖入ftp上的public_html文件夹中

![](/images/posts/8a291f21/94c07f697492.png)

### 创建数据库
然后进入三蛋空间创建数据库
三蛋空间会自动给你的数据库名字前加上数字,所以之后在贴吧安装中要注意

![](/images/posts/8a291f21/7ceb820578ab.png)
...
![](/images/posts/8a291f21/b796661bef62.png)
